...
gulp-npm-script-sync@^1.1.0:
  version "1.1.0"
  resolved "https://registry.yarnpkg.com/gulp-npm-script-sync/-/gulp-npm-script-sync-1.1.0.tgz#f7de1e865b273c90760e432e0f6131bacf5cbc68"
  dependencies:
    detect-indent "^3.0.0"
...
gulp-run-command@^0.0.7:
  version "0.0.7"
  resolved "https://registry.yarnpkg.com/gulp-run-command/-/gulp-run-command-0.0.7.tgz#eb8e209e75b5a0171e75909f4d4fd27d2473cfca"
  dependencies:
    babel-plugin-transform-runtime "6.15.0"
    cross-spawn "4.0.0"
    spawn-args "0.2.0"
