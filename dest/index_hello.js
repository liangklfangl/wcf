...
// module
exports.push([module.i, "html{background-color:pink;display:-webkit-box;display:-ms-flexbox;display:flex}", "", {"version":3,"sources":["/./Users/Administrator/Desktop/wcf/test/styles.css"],"names":[],"mappings":"AAAA,KACC,sBAAsB,AACtB,oBAAa,AAAb,oBAAa,AAAb,YAAa,CACb","file":"styles.css","sourcesContent":["html{\r\n\tbackground-color:pink;\r\n\tdisplay:flex;\r\n}"],"sourceRoot":"webpack://"}]);
...
exports.writeTextToElement = writeTextToElement;
...
function writeTextToElement(id, text) {
    (0, _jquery2.default)('#' + id).text(text);
}
if (true) {
    module.hot.decline(1);
}
...
var moduleStartTime = getCurrentSeconds();
...
if (true) {
    ...
    if (data.moduleStartTime) moduleStartTime = data.moduleStartTime;
...
var _pulse = __webpack_require__(3);
...
var intervalId = window.setInterval(function () {
    ...
    dom.writeTextToElement('lastPulse', (0, _pulse2.default)());
}, UPDATE_INTERVAL);
// Activate Webpack HMR
// if (module.hot) {
//     module.hot.accept();
...
//# sourceMappingURL=index_hello.js.map